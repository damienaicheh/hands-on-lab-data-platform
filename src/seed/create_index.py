...
async def apply_data_source() -> None:
    ...
    await indexer_client.create_or_update_data_source_connection(
        SearchIndexerDataSourceConnection.deserialize(body)
    )
...
async def apply_index() -> None:
    ...
    await index_client.create_or_update_index(SearchIndex.deserialize(body))
...
async def apply_skillset() -> None:
    ...
    await indexer_client.create_or_update_skillset(
        SearchIndexerSkillset.deserialize(body)
    )
...
async def apply_indexer() -> None:
    ...
    await indexer_client.create_or_update_indexer(SearchIndexer.deserialize(body))
